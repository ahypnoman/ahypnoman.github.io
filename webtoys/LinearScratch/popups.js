...
const popups = {
    ...
    newExtension: () => {
        insertPopup("Add extension", closePopupButton(), `<div class="popupFullyCenteredContent"><div style="transform: scale(140%);"><button class="buttonWithImage" onclick="closePopup(); popups.addPremadeExtension()"><div>Built in extension</div><img width="127" src="/images/Add_ex_premade.svg" alt="create file image"></button><button class="buttonWithImage" onclick="closePopup();popups.customExtension()"><div>Custom extension</div><img src="/images/Add_ex_custom.svg" alt="create file image"></button></div></div>`)
    },
    customExtension: () => {
        insertPopup("Add extension", closePopupButton(), `<div class="popupFullyCenteredContent"><div style="transform: scale(140%);"><button class="buttonWithImage" onclick="closePopup(); popups.importExtension()"><div>Import extension</div><img width="127" src="/images/Import_file.svg" alt="create file image"></button><button class="buttonWithImage" onclick="closePopup();popups.createExtension()"><div>Create extension</div><img src="/images/Create_file.svg" alt="create file image"></button></div></div>`)
    },
    createExtension: () => {
